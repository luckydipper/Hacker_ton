...
apikey = 'A0BCA60379F8E02C192C72FE88D30264'
...
- - - 게임 방법 - - -
가장 처음 단어를 제시하면 끝말잇기가 시작돼!
'GG'를 입력하면 게임이 종료돼!
- - - 게임 규칙 - - -
1. 사전에 등재된 명사여야 하구
2. 적어도 단어의 길이가 두 글자 이상이어야 하며
3. 이미 사용한 단어를 다시 사용할 수 없어!
4. 두음법칙까지는 허용해줄게 (ex. 리->니)
==========================================
''')
    ...
    while(not wordOK):
        ...
        if query == 'GG':
            ...
            if query == '':
                ...
                if len(history)==0:
                    print('단어를 입력하여 끝말잇기를 시작해.')
                else:
                    print(sword + '(으)로 시작하는 단어를 입력해.')
